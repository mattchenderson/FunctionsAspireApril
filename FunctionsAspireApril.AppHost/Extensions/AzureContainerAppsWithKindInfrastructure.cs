...
/// </summary>
internal sealed class AzureContainerAppsWithKindInfrastructure(
    ILogger<AzureContainerAppsWithKindInfrastructure> logger,
    ...
    DistributedApplicationExecutionContext executionContext) : IDistributedApplicationLifecycleHook
{
    public async Task BeforeStartAsync(DistributedApplicationModel appModel, CancellationToken cancellationToken = default)
    {
        ...
        var caes = appModel.Resources.OfType<Aspire.Hosting.Azure.AppContainers.AzureContainerAppEnvironmentResource>().ToArray();
       ...
       )
    {
        ...
        private sealed class ContainerAppContext(IResource resource, ContainerAppEnvironmentContext containerAppEnvironmentContext)
        {
            ...
            public void BuildContainerApp(AzureResourceInfrastructure c)
            {
                ...
                var containerAppResource = new ContainerAppWithKind(Infrastructure.NormalizeBicepIdentifier(resource.Name))
                {
                ...
                if (resource.TryGetAnnotationsOfType<AzureContainerAppWithKindCustomizationAnnotation>(out var annotations))
                {
...
internal class AzureContainerAppWithKindCustomizationAnnotation(Action<AzureResourceInfrastructure, ContainerAppWithKind> configure) : IResourceAnnotation
{
    /// <summary>
...
#pragma warning restore ASPIRECOMPUTE001 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
{
    ...
    /// </summary>
    private BicepOutputReference ContainerAppEnvironmentId => new("AZURE_CONTAAAAAAAINER_APPS_ENVIRONMENT_ID", this);
